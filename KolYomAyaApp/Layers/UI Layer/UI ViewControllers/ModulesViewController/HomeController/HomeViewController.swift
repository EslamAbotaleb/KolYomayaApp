...
//    static var shareButton =  UILabel()
//    static var playPauseButton =  UILabel()
//
...
//
//        HomeViewController.shareButton.widthAnchor.constraint(equalToConstant: 100.0).isActive = true
//        HomeViewController.shareButton.heightAnchor.constraint(equalToConstant: 20.0).isActive = true
//        HomeViewController.shareButton.textColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
//
//        HomeViewController.shareButton.text  = "مشاركة   "
//        HomeViewController.shareButton.textAlignment = .center
//
//        let image: UIImage = UIImage(named: "share")!
//
//            var bgImage: UIImageView?
//            bgImage = UIImageView(image: image)
//        bgImage!.frame = CGRect(x: 0, y: 15, width: 25, height: 25)
//
//        HomeViewController.shareButton.addSubview(bgImage!)
//
//
//        //Text Label
////        let anothertextLabel = UILabel()
//        HomeViewController.playPauseButton.translatesAutoresizingMaskIntoConstraints = false
//
//        HomeViewController.playPauseButton.widthAnchor.constraint(equalToConstant: 100.0).isActive = true
//        HomeViewController.playPauseButton.heightAnchor.constraint(equalToConstant: 20.0).isActive = true
//        HomeViewController.playPauseButton.textColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
//        HomeViewController.playPauseButton.text  = "تشغيل"
//        HomeViewController.playPauseButton.textAlignment = .center
//
//        let playimage: UIImage = UIImage(named: "play_icon")!
//
//            var bgplayimage: UIImageView?
//        bgplayimage = UIImageView(image: playimage)
//        bgplayimage!.frame = CGRect(x: 0, y: 15, width: 25, height: 25)
//
//        HomeViewController.playPauseButton.addSubview(bgplayimage!)
//
//
//        stackView.addArrangedSubview(HomeViewController.shareButton)
//        stackView.addArrangedSubview(HomeViewController.playPauseButton)
//
...
//            HomeViewController.playPauseButton.widthAnchor.constraint(equalToConstant: 110.0).isActive = true
//            HomeViewController.playPauseButton.heightAnchor.constraint(equalToConstant: 20.0).isActive = true
//            HomeViewController.playPauseButton.textColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
//            HomeViewController.playPauseButton.text  = "ايقاف"
//            HomeViewController.playPauseButton.textAlignment = .center
//
//            let pauseimage: UIImage = UIImage(named: "pause_icon")!
//
//                var bgpauseimage: UIImageView?
//            bgpauseimage = UIImageView(image: pauseimage)
//            bgpauseimage!.frame = CGRect(x: 0, y: 15, width: 25, height: 25)
//
//            HomeViewController.playPauseButton.addSubview(bgpauseimage!)
//
...
//                        element in
//                        if element.name == todayAyaModel.ayaObject?.suraName {
...
//                        element in
//                        if element.name == todayAyaModel.ayaObject?.suraName {
//                            print("fekgekgjregr\("http://212.57.192.148/ayat/mp3/\(readerObject!)/\(element.id)\(self!.appendNumberAya!).mp3")")
//
...
//                    //                        guard let url = URL.init(string:
//                    ////                                                    "http://212.57.192.148/ayat/mp3/Husary_64kbps/082002.mp3"
//                    //                                                    "http://212.57.192.148/ayat/mp3/\(readerObject!)/\(KeyAndValue.SURA_NAME[indexAyaname].id)\(self!.appendNumberAya!).mp3"
//                    //                        ) else { return }
//                    //                        print("caledurlaudio\("http://212.57.192.148/ayat/mp3/\(readerObject!)/\(KeyAndValue.SURA_NAME[indexAyaname].id)\(self!.appendNumberAya!).mp3")")
//                    //                        let playerItem = AVPlayerItem.init(url: url)
//                    //                        NotificationCenter.default.addObserver(self!, selector: #selector(self?.playerDidFinishPlaying(sender:)), name: NSNotification.Name.AVPlayerItemDidPlayToEndTime, object: playerItem)
//                    //                        self?.player = AVPlayer.init(playerItem: playerItem)
//                    //                        self?.player?.play()
//                    //                        print("fekfefefefhewkfwe\(KeyAndValue.SURA_NAME[indexAyaname].id)")
//                    //                        break
//                    //                    }
//                }
//            }
...
//                        element in
//                        if element.name == todayAyaModel.ayaObject?.suraName {
//                            guard let url = URL.init(string: "http://212.57.192.148/ayat/mp3/\(readerObject!)/\(element.id)\(self!.appendNumberAya!).mp3") else { return }
//                            let playerItem = AVPlayerItem.init(url: url)
//
//                            //                            NotificationCenter.default.addObserver(self!, selector: #selector(self?.playerDidFinishPlaying(sender:)), name: NSNotification.Name.AVPlayerItemDidPlayToEndTime, object: playerItem)
//                            self?.player = AVPlayer.init(playerItem: playerItem)
...
//        self.view.isUserInteractionEnabled = false
    ...
    @objc func playAyaBySpesficReciter() {
